                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select w-50" id="jurusan" name="jurusan">
                            ...
                            <option value="D3 Sistem Informasi" <?php if ($siswa['jurusan'] == 'D3 Teknologi Informasi') { ?> selected='' <?php } ?>>D3 Teknologi Informasi</option>
                            <option value="D3 Sistem Informasi" <?php if ($siswa['jurusan'] == 'D4 Teknologi Game') { ?> selected='' <?php } ?>>D4 Teknologi Game</option>
                        </select>
                    </div>
                    <div class="mb-3">
